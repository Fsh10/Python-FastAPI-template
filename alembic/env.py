...
from src.organizations.OrganizationModel import *
from src.positions.PositionModel import *
...
if settings.ENVIRONMENT == "TESTING":
    config.set_section_option(section, "POSTGRES_DB", settings.POSTGRES_DB_TEST)
else:
